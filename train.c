...
void exit_with_help()
{
	...
	"  for prox-newton exp\n"
	"   20 -- Prox Newton L1-regularized LR (no shrinking)\n"
	"   21 -- Prox Newton L1-regularized LR (no shrinking, uniform subsample)\n"
	"   22 -- Prox Newton L1-regularized LR (no shrinking, Catalyst)\n"
